About cuda-libraries-static-feedstock
=====================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cuda-libraries-static-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuda-libraries-static-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cuda-libraries-static
# for installing globally
pixi global install cuda-libraries-static
```
...
It is possible to list all of the versions of `cuda-libraries-static` available on your platform:
...
```
pixi search cuda-libraries-static --channel conda-forge
```
